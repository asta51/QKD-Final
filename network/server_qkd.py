...
class SecureServer:
    ...
    def _combine_keys(self, key_bb84, key_e91):
        """
        Convert bits to integers, apply Brahmagupta mapping, then back to bits
        """
        ...
        return combined_bits[:len(key_bb84)]  # trim to original key length
    ...
    def _handle_client(self, conn, addr):
        try:
            ...
            # Combine using Brahmagupta mapping
